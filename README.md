...
В 2022 году я увлекся программированием и
последние несколько лет прошли в непрерывных (ежедненых) занятиях, которые позволили серьезно развить мои it-компетенции. Основной упор идет на Python и веб-разработку.
